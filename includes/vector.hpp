...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/29 15:33:08 by                   #+#    #+#             */
/*   Updated: 2021/12/29 15:44:48 by                  ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class vector {
 ...
 private:
    pointer             _array;  // pointer to allocated memory
    size_type           _capacity;  // size of allocated memory
    size_type           _numOfElem;  // num of elements
    allocator_type      _alloc;  // some mechanism for allocating memory
 ...
 public:
    ...
    vector(InputIterator first, InputIterator last,
           ...
           _alloc(alloc), _array(NULL), _capacity(0), _numOfElem(0) {
